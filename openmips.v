 ...
 * @LastEditTime: 2022-02-16 12:25:48
 * @LastEditors: Groot
 * @Description:
...
`include "openMIPS/regfile.v"
`include "openMIPS/pc_reg.v"
`include "openMIPS/if_id.v"
`include "openMIPS/id.v"
`include "openMIPS/id_ex.v"
`include "openMIPS/ex.v"
`include "openMIPS/ex_mem.v"
`include "openMIPS/mem.v"
`include "openMIPS/mem_wb.v"

module openmips (input wire clk,
                 input wire rst,
                 input wire[`InstBus] rom_data_i,
                 output reg[`InstAddrBus] rom_addr_o,
