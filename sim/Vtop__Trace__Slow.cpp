...
void Vtop___024root__traceInitSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+135,"top clk", false,-1);
        tracep->declBit(c+136,"top rst", false,-1);
        ...
        tracep->declBus(c+86,"top ram_addr_i", false,-1, 31,0);
        tracep->declBus(c+87,"top ram_data_o", false,-1, 31,0);
        tracep->declBus(c+88,"top ram_sel_i", false,-1, 3,0);
        tracep->declBit(c+89,"top ram_ce_i", false,-1);
        tracep->declBit(c+90,"top ram_we_i", false,-1);
        tracep->declBit(c+91,"top ram_data_i", false,-1);
        tracep->declBit(c+135,"top openmips0 clk", false,-1);
        tracep->declBit(c+136,"top openmips0 rst", false,-1);
        ...
        tracep->declBus(c+87,"top openmips0 ram_data_i", false,-1, 31,0);
        tracep->declBus(c+86,"top openmips0 ram_addr_o", false,-1, 31,0);
        tracep->declBus(c+92,"top openmips0 ram_data_o", false,-1, 31,0);
        tracep->declBit(c+90,"top openmips0 ram_we_o", false,-1);
        tracep->declBit(c+89,"top openmips0 ram_ce_o", false,-1);
        tracep->declBus(c+88,"top openmips0 ram_sel_o", false,-1, 3,0);
        ...
        tracep->declBus(c+93,"top openmips0 id_aluop_o", false,-1, 7,0);
        tracep->declBus(c+94,"top openmips0 id_alusel_o", false,-1, 2,0);
        tracep->declBus(c+95,"top openmips0 id_reg1_o", false,-1, 31,0);
        tracep->declBus(c+96,"top openmips0 id_reg2_o", false,-1, 31,0);
        tracep->declBit(c+97,"top openmips0 id_wreg_o", false,-1);
        tracep->declBus(c+98,"top openmips0 id_wd_o", false,-1, 4,0);
        tracep->declBit(c+137,"top openmips0 id_is_in_delayslot_o", false,-1);
        tracep->declBus(c+99,"top openmips0 id_link_addr_o", false,-1, 31,0);
        tracep->declBit(c+100,"top openmips0 id_next_inst_in_delayslot_o", false,-1);
        ...
        tracep->declBus(c+101,"top openmips0 ex_wdata_o", false,-1, 31,0);
        tracep->declBit(c+102,"top openmips0 ex_whilo_o", false,-1);
        tracep->declBus(c+103,"top openmips0 ex_hi_o", false,-1, 31,0);
        tracep->declBus(c+104,"top openmips0 ex_lo_o", false,-1, 31,0);
        ...
        tracep->declBit(c+105,"top openmips0 mem_wreg_o", false,-1);
        tracep->declBus(c+106,"top openmips0 mem_wd_o", false,-1, 4,0);
        tracep->declBus(c+107,"top openmips0 mem_wdata_o", false,-1, 31,0);
        tracep->declBit(c+108,"top openmips0 mem_whilo_o", false,-1);
        tracep->declBus(c+109,"top openmips0 mem_hi_o", false,-1, 31,0);
        tracep->declBus(c+110,"top openmips0 mem_lo_o", false,-1, 31,0);
        ...
        tracep->declBit(c+111,"top openmips0 reg1_read", false,-1);
        tracep->declBit(c+112,"top openmips0 reg2_read", false,-1);
        tracep->declBus(c+138,"top openmips0 reg1_data", false,-1, 31,0);
        tracep->declBus(c+139,"top openmips0 reg2_data", false,-1, 31,0);
        tracep->declBus(c+113,"top openmips0 reg1_addr", false,-1, 4,0);
        tracep->declBus(c+114,"top openmips0 reg2_addr", false,-1, 4,0);
        tracep->declBus(c+32,"top openmips0 hi", false,-1, 31,0);
        tracep->declBus(c+33,"top openmips0 lo", false,-1, 31,0);
        tracep->declBus(c+115,"top openmips0 stall", false,-1, 5,0);
        tracep->declBit(c+140,"top openmips0 stallreq_from_id", false,-1);
        tracep->declBit(c+116,"top openmips0 stallreq_from_ex", false,-1);
        tracep->declBus(c+34,"top openmips0 cnt_i", false,-1, 1,0);
        tracep->declQuad(c+35,"top openmips0 hilo_temp_i", false,-1, 63,0);
        tracep->declBus(c+117,"top openmips0 cnt_o", false,-1, 1,0);
        tracep->declQuad(c+118,"top openmips0 hilo_temp_o", false,-1, 63,0);
        tracep->declBit(c+37,"top openmips0 is_in_delayslot_i", false,-1);
        tracep->declBit(c+141,"top openmips0 is_in_delayslot_o", false,-1);
        tracep->declBus(c+120,"top openmips0 branch_target_address", false,-1, 31,0);
        tracep->declBit(c+121,"top openmips0 id_branch_flag_o", false,-1);
        tracep->declBit(c+135,"top openmips0 pc_reg0 clk", false,-1);
        tracep->declBit(c+136,"top openmips0 pc_reg0 rst", false,-1);
        tracep->declBus(c+115,"top openmips0 pc_reg0 stall", false,-1, 5,0);
        tracep->declBit(c+121,"top openmips0 pc_reg0 branch_flag_i", false,-1);
        tracep->declBit(c+3,"top openmips0 pc_reg0 ce", false,-1);
        tracep->declBus(c+1,"top openmips0 pc_reg0 pc", false,-1, 31,0);
        tracep->declBus(c+120,"top openmips0 pc_reg0 branch_target_address_i", false,-1, 31,0);
        tracep->declBit(c+135,"top openmips0 if_id0 clk", false,-1);
        tracep->declBit(c+136,"top openmips0 if_id0 rst", false,-1);
        tracep->declBus(c+1,"top openmips0 if_id0 if_pc", false,-1, 31,0);
        tracep->declBus(c+2,"top openmips0 if_id0 if_inst", false,-1, 31,0);
        tracep->declBus(c+115,"top openmips0 if_id0 stall", false,-1, 5,0);
        tracep->declBus(c+4,"top openmips0 if_id0 id_pc", false,-1, 31,0);
        tracep->declBus(c+5,"top openmips0 if_id0 id_inst", false,-1, 31,0);
        tracep->declBit(c+136,"top openmips0 id0 rst", false,-1);
        tracep->declBus(c+4,"top openmips0 id0 pc_i", false,-1, 31,0);
        tracep->declBus(c+5,"top openmips0 id0 inst_i", false,-1, 31,0);
        tracep->declBus(c+138,"top openmips0 id0 reg1_data_i", false,-1, 31,0);
        tracep->declBus(c+139,"top openmips0 id0 reg2_data_i", false,-1, 31,0);
        tracep->declBit(c+13,"top openmips0 id0 ex_wreg_i", false,-1);
        tracep->declBus(c+11,"top openmips0 id0 ex_wd_i", false,-1, 4,0);
        tracep->declBus(c+101,"top openmips0 id0 ex_wdata_i", false,-1, 31,0);
        tracep->declBit(c+105,"top openmips0 id0 mem_wreg_i", false,-1);
        tracep->declBus(c+106,"top openmips0 id0 mem_wd_i", false,-1, 4,0);
        tracep->declBus(c+107,"top openmips0 id0 mem_wdata_i", false,-1, 31,0);
        tracep->declBit(c+141,"top openmips0 id0 is_in_delayslot_i", false,-1);
        tracep->declBit(c+111,"top openmips0 id0 reg1_read_o", false,-1);
        tracep->declBit(c+112,"top openmips0 id0 reg2_read_o", false,-1);
        tracep->declBus(c+113,"top openmips0 id0 reg1_addr_o", false,-1, 4,0);
        tracep->declBus(c+114,"top openmips0 id0 reg2_addr_o", false,-1, 4,0);
        tracep->declBus(c+93,"top openmips0 id0 aluop_o", false,-1, 7,0);
        tracep->declBus(c+94,"top openmips0 id0 alusel_o", false,-1, 2,0);
        tracep->declBus(c+95,"top openmips0 id0 reg1_o", false,-1, 31,0);
        tracep->declBus(c+96,"top openmips0 id0 reg2_o", false,-1, 31,0);
        tracep->declBus(c+98,"top openmips0 id0 wd_o", false,-1, 4,0);
        tracep->declBit(c+97,"top openmips0 id0 wreg_o", false,-1);
        tracep->declBit(c+140,"top openmips0 id0 stallreq", false,-1);
        tracep->declBit(c+121,"top openmips0 id0 branch_flag_o", false,-1);
        tracep->declBus(c+120,"top openmips0 id0 branch_target_address_o", false,-1, 31,0);
        tracep->declBit(c+100,"top openmips0 id0 next_inst_in_delayslot_o", false,-1);
        tracep->declBit(c+137,"top openmips0 id0 is_in_delayslot_o", false,-1);
        tracep->declBus(c+99,"top openmips0 id0 link_addr_o", false,-1, 31,0);
        ...
        tracep->declBus(c+122,"top openmips0 id0 imm", false,-1, 31,0);
        tracep->declBit(c+123,"top openmips0 id0 instvalid", false,-1);
        ...
        tracep->declBit(c+135,"top openmips0 regfile1 clk", false,-1);
        tracep->declBit(c+136,"top openmips0 regfile1 rst", false,-1);
        ...
        tracep->declBit(c+111,"top openmips0 regfile1 re1", false,-1);
        tracep->declBus(c+113,"top openmips0 regfile1 raddr1", false,-1, 4,0);
        tracep->declBus(c+138,"top openmips0 regfile1 rdata1", false,-1, 31,0);
        tracep->declBit(c+112,"top openmips0 regfile1 re2", false,-1);
        tracep->declBus(c+114,"top openmips0 regfile1 raddr2", false,-1, 4,0);
        tracep->declBus(c+139,"top openmips0 regfile1 rdata2", false,-1, 31,0);
        {int i; for (i=0; i<32; i++) {
                tracep->declBus(c+45+i*1,"top openmips0 regfile1 regs", true,(i+0), 31,0);}}
        tracep->declBit(c+135,"top openmips0 id_ex0 clk", false,-1);
        tracep->declBit(c+136,"top openmips0 id_ex0 rst", false,-1);
        tracep->declBus(c+93,"top openmips0 id_ex0 id_aluop", false,-1, 7,0);
        tracep->declBus(c+94,"top openmips0 id_ex0 id_alusel", false,-1, 2,0);
        tracep->declBus(c+95,"top openmips0 id_ex0 id_reg1", false,-1, 31,0);
        tracep->declBus(c+96,"top openmips0 id_ex0 id_reg2", false,-1, 31,0);
        tracep->declBus(c+98,"top openmips0 id_ex0 id_wd", false,-1, 4,0);
        tracep->declBit(c+97,"top openmips0 id_ex0 id_wreg", false,-1);
        tracep->declBus(c+115,"top openmips0 id_ex0 stall", false,-1, 5,0);
        tracep->declBit(c+137,"top openmips0 id_ex0 id_is_in_delayslot", false,-1);
        tracep->declBus(c+99,"top openmips0 id_ex0 id_link_address", false,-1, 31,0);
        tracep->declBit(c+100,"top openmips0 id_ex0 next_inst_in_delayslot_i", false,-1);
        ...
        tracep->declBit(c+136,"top openmips0 ex0 rst", false,-1);
        ...
        tracep->declBus(c+101,"top openmips0 ex0 wdata_o", false,-1, 31,0);
        ...
        tracep->declBus(c+109,"top openmips0 ex0 mem_hi_i", false,-1, 31,0);
        tracep->declBus(c+110,"top openmips0 ex0 mem_lo_i", false,-1, 31,0);
        ...
        tracep->declBit(c+102,"top openmips0 ex0 whilo_o", false,-1);
        tracep->declBus(c+103,"top openmips0 ex0 hi_o", false,-1, 31,0);
        tracep->declBus(c+104,"top openmips0 ex0 lo_o", false,-1, 31,0);
        tracep->declBit(c+116,"top openmips0 ex0 stallreq", false,-1);
        tracep->declQuad(c+35,"top openmips0 ex0 hilo_temp_i", false,-1, 63,0);
        tracep->declBus(c+34,"top openmips0 ex0 cnt_i", false,-1, 1,0);
        tracep->declQuad(c+118,"top openmips0 ex0 hilo_temp_o", false,-1, 63,0);
        tracep->declBus(c+117,"top openmips0 ex0 cnt_o", false,-1, 1,0);
        ...
        tracep->declBus(c+124,"top openmips0 ex0 logicout", false,-1, 31,0);
        tracep->declBus(c+125,"top openmips0 ex0 shiftres", false,-1, 31,0);
        tracep->declBus(c+126,"top openmips0 ex0 movres", false,-1, 31,0);
        tracep->declBus(c+127,"top openmips0 ex0 HI", false,-1, 31,0);
        tracep->declBus(c+128,"top openmips0 ex0 LO", false,-1, 31,0);
        tracep->declBit(c+77,"top openmips0 ex0 ov_sum", false,-1);
        tracep->declBit(c+142,"top openmips0 ex0 reg1_eq_reg2", false,-1);
        tracep->declBit(c+78,"top openmips0 ex0 reg1_lt_reg2", false,-1);
        tracep->declBus(c+129,"top openmips0 ex0 arithmeticres", false,-1, 31,0);
        ...
        tracep->declQuad(c+130,"top openmips0 ex0 hilo_temp1", false,-1, 63,0);
        tracep->declBit(c+116,"top openmips0 ex0 stallreq_for_madd_msub", false,-1);
        tracep->declQuad(c+132,"top openmips0 ex0 mulres", false,-1, 63,0);
        tracep->declBit(c+135,"top openmips0 ex_mem0 clk", false,-1);
        tracep->declBit(c+136,"top openmips0 ex_mem0 rst", false,-1);
        tracep->declBus(c+115,"top openmips0 ex_mem0 stall", false,-1, 5,0);
        tracep->declBus(c+11,"top openmips0 ex_mem0 ex_wd", false,-1, 4,0);
        tracep->declBit(c+13,"top openmips0 ex_mem0 ex_wreg", false,-1);
        tracep->declBus(c+101,"top openmips0 ex_mem0 ex_wdata", false,-1, 31,0);
        ...
        tracep->declBit(c+102,"top openmips0 ex_mem0 ex_whilo", false,-1);
        tracep->declBus(c+103,"top openmips0 ex_mem0 ex_hi", false,-1, 31,0);
        tracep->declBus(c+104,"top openmips0 ex_mem0 ex_lo", false,-1, 31,0);
        ...
        tracep->declQuad(c+118,"top openmips0 ex_mem0 hilo_i", false,-1, 63,0);
        tracep->declBus(c+117,"top openmips0 ex_mem0 cnt_i", false,-1, 1,0);
        ...
        tracep->declBit(c+136,"top openmips0 mem0 rst", false,-1);
        ...
        tracep->declBus(c+106,"top openmips0 mem0 wd_o", false,-1, 4,0);
        tracep->declBit(c+105,"top openmips0 mem0 wreg_o", false,-1);
        tracep->declBus(c+107,"top openmips0 mem0 wdata_o", false,-1, 31,0);
        ...
        tracep->declBit(c+108,"top openmips0 mem0 whilo_o", false,-1);
        tracep->declBus(c+109,"top openmips0 mem0 hi_o", false,-1, 31,0);
        tracep->declBus(c+110,"top openmips0 mem0 lo_o", false,-1, 31,0);
        ...
        tracep->declBus(c+87,"top openmips0 mem0 mem_data_i", false,-1, 31,0);
        tracep->declBus(c+86,"top openmips0 mem0 mem_addr_o", false,-1, 31,0);
        tracep->declBit(c+90,"top openmips0 mem0 mem_we_o", false,-1);
        tracep->declBus(c+88,"top openmips0 mem0 mem_sel_o", false,-1, 3,0);
        tracep->declBus(c+92,"top openmips0 mem0 mem_data_o", false,-1, 31,0);
        tracep->declBit(c+89,"top openmips0 mem0 mem_ce_o", false,-1);
        tracep->declBit(c+135,"top openmips0 mem_wb0 clk", false,-1);
        tracep->declBit(c+136,"top openmips0 mem_wb0 rst", false,-1);
        tracep->declBus(c+115,"top openmips0 mem_wb0 stall", false,-1, 5,0);
        tracep->declBus(c+106,"top openmips0 mem_wb0 mem_wd", false,-1, 4,0);
        tracep->declBit(c+105,"top openmips0 mem_wb0 mem_wreg", false,-1);
        tracep->declBus(c+107,"top openmips0 mem_wb0 mem_wdata", false,-1, 31,0);
        ...
        tracep->declBit(c+108,"top openmips0 mem_wb0 mem_whilo", false,-1);
        tracep->declBus(c+109,"top openmips0 mem_wb0 mem_hi", false,-1, 31,0);
        tracep->declBus(c+110,"top openmips0 mem_wb0 mem_lo", false,-1, 31,0);
        ...
        tracep->declBit(c+136,"top openmips0 hilo_reg0 rst", false,-1);
        tracep->declBit(c+135,"top openmips0 hilo_reg0 clk", false,-1);
        ...
        tracep->declBit(c+136,"top openmips0 ctrl0 rst", false,-1);
        tracep->declBit(c+140,"top openmips0 ctrl0 stallreq_from_id", false,-1);
        tracep->declBit(c+116,"top openmips0 ctrl0 stallreq_from_ex", false,-1);
        tracep->declBus(c+115,"top openmips0 ctrl0 stall", false,-1, 5,0);
        ...
        tracep->declBit(c+135,"top data_ram0 clk", false,-1);
        tracep->declBit(c+89,"top data_ram0 ce", false,-1);
        tracep->declBit(c+90,"top data_ram0 we", false,-1);
        tracep->declBus(c+86,"top data_ram0 addr", false,-1, 31,0);
        tracep->declBus(c+88,"top data_ram0 sel", false,-1, 3,0);
        tracep->declBus(c+134,"top data_ram0 data_i", false,-1, 31,0);
        tracep->declBus(c+87,"top data_ram0 data_o", false,-1, 31,0);
    }
}
...
void Vtop___024root__traceFullSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullIData(oldp+86,(vlSelf->top__DOT__ram_addr_i),32);
        tracep->fullIData(oldp+87,(vlSelf->top__DOT__ram_data_o),32);
        tracep->fullCData(oldp+88,(vlSelf->top__DOT__ram_sel_i),4);
        tracep->fullBit(oldp+89,(vlSelf->top__DOT__ram_ce_i));
        tracep->fullBit(oldp+90,(vlSelf->top__DOT__ram_we_i));
        tracep->fullBit(oldp+91,((1U & vlSelf->top__DOT____Vcellout__openmips0__ram_data_o)));
        tracep->fullIData(oldp+92,(vlSelf->top__DOT____Vcellout__openmips0__ram_data_o),32);
        tracep->fullCData(oldp+93,(vlSelf->top__DOT__openmips0__DOT__id_aluop_o),8);
        tracep->fullCData(oldp+94,(vlSelf->top__DOT__openmips0__DOT__id_alusel_o),3);
        tracep->fullIData(oldp+95,(vlSelf->top__DOT__openmips0__DOT__id_reg1_o),32);
        tracep->fullIData(oldp+96,(vlSelf->top__DOT__openmips0__DOT__id_reg2_o),32);
        tracep->fullBit(oldp+97,(vlSelf->top__DOT__openmips0__DOT__id_wreg_o));
        tracep->fullCData(oldp+98,(vlSelf->top__DOT__openmips0__DOT__id_wd_o),5);
        tracep->fullIData(oldp+99,(vlSelf->top__DOT__openmips0__DOT__id_link_addr_o),32);
        tracep->fullBit(oldp+100,(vlSelf->top__DOT__openmips0__DOT__id_next_inst_in_delayslot_o));
        tracep->fullIData(oldp+101,(vlSelf->top__DOT__openmips0__DOT__ex_wdata_o),32);
        tracep->fullBit(oldp+102,(vlSelf->top__DOT__openmips0__DOT__ex_whilo_o));
        tracep->fullIData(oldp+103,(vlSelf->top__DOT__openmips0__DOT__ex_hi_o),32);
        tracep->fullIData(oldp+104,(vlSelf->top__DOT__openmips0__DOT__ex_lo_o),32);
        tracep->fullBit(oldp+105,(vlSelf->top__DOT__openmips0__DOT__mem_wreg_o));
        tracep->fullCData(oldp+106,(vlSelf->top__DOT__openmips0__DOT__mem_wd_o),5);
        tracep->fullIData(oldp+107,(vlSelf->top__DOT__openmips0__DOT__mem_wdata_o),32);
        tracep->fullBit(oldp+108,(vlSelf->top__DOT__openmips0__DOT__mem_whilo_o));
        tracep->fullIData(oldp+109,(vlSelf->top__DOT__openmips0__DOT__mem_hi_o),32);
        tracep->fullIData(oldp+110,(vlSelf->top__DOT__openmips0__DOT__mem_lo_o),32);
        tracep->fullBit(oldp+111,(vlSelf->top__DOT__openmips0__DOT__reg1_read));
        tracep->fullBit(oldp+112,(vlSelf->top__DOT__openmips0__DOT__reg2_read));
        tracep->fullCData(oldp+113,(vlSelf->top__DOT__openmips0__DOT__reg1_addr),5);
        tracep->fullCData(oldp+114,(vlSelf->top__DOT__openmips0__DOT__reg2_addr),5);
        tracep->fullCData(oldp+115,(vlSelf->top__DOT__openmips0__DOT__stall),6);
        tracep->fullBit(oldp+116,(vlSelf->top__DOT__openmips0__DOT__ex0__DOT__stallreq_for_madd_msub));
        tracep->fullCData(oldp+117,(vlSelf->top__DOT__openmips0__DOT__cnt_o),2);
        tracep->fullQData(oldp+118,(vlSelf->top__DOT__openmips0__DOT__hilo_temp_o),64);
        tracep->fullIData(oldp+120,(vlSelf->top__DOT__openmips0__DOT__branch_target_address),32);
        tracep->fullBit(oldp+121,(vlSelf->top__DOT__openmips0__DOT__id_branch_flag_o));
        tracep->fullIData(oldp+122,(vlSelf->top__DOT__openmips0__DOT__id0__DOT__imm),32);
        tracep->fullBit(oldp+123,(vlSelf->top__DOT__openmips0__DOT__id0__DOT__instvalid));
        tracep->fullIData(oldp+124,(vlSelf->top__DOT__openmips0__DOT__ex0__DOT__logicout),32);
        tracep->fullIData(oldp+125,(vlSelf->top__DOT__openmips0__DOT__ex0__DOT__shiftres),32);
        tracep->fullIData(oldp+126,(vlSelf->top__DOT__openmips0__DOT__ex0__DOT__movres),32);
        tracep->fullIData(oldp+127,(vlSelf->top__DOT__openmips0__DOT__ex0__DOT__HI),32);
        tracep->fullIData(oldp+128,(vlSelf->top__DOT__openmips0__DOT__ex0__DOT__LO),32);
        tracep->fullIData(oldp+129,(vlSelf->top__DOT__openmips0__DOT__ex0__DOT__arithmeticres),32);
        tracep->fullQData(oldp+130,(vlSelf->top__DOT__openmips0__DOT__ex0__DOT__hilo_temp1),64);
        tracep->fullQData(oldp+132,(vlSelf->top__DOT__openmips0__DOT__ex0__DOT__mulres),64);
        tracep->fullIData(oldp+134,((1U & vlSelf->top__DOT____Vcellout__openmips0__ram_data_o)),32);
        tracep->fullBit(oldp+135,(vlSelf->clk));
        tracep->fullBit(oldp+136,(vlSelf->rst));
        tracep->fullBit(oldp+137,(((~ (IData)(vlSelf->rst)) 
                                   & (IData)(vlSelf->top__DOT__openmips0__DOT__is_in_delayslot_o))));
        tracep->fullIData(oldp+138,(((IData)(vlSelf->rst)
                                               ...
                                               : ((
                                                  ...
                                                  ((IData)(vlSelf->top__DOT__openmips0__DOT__reg1_read)
                                                   ...
                                                   [vlSelf->top__DOT__openmips0__DOT__reg1_addr]
                                                    : 0U))))),32);
        tracep->fullIData(oldp+139,(((IData)(vlSelf->rst)
        ...
        tracep->fullBit(oldp+141,(vlSelf->top__DOT__openmips0__DOT__is_in_delayslot_o));
        tracep->fullBit(oldp+142,(vlSelf->top__DOT__openmips0__DOT__ex0__DOT__reg1_eq_reg2));
    }
}
